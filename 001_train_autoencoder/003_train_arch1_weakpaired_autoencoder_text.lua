-- Code to train an autoencoder based on only text of  weak paired text and image data for architecture 1
...
cmd:option('-save_model_every', 35000, 'saving model every half epoch')
