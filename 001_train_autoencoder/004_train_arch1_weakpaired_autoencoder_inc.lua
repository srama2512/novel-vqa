...
cmd:option('-cnn_model','/home/santhosh/Projects/VQA/CVPR-Work/googlenet/inception-v3.torch/inceptionv3.net','path to CNN model file containing the weights, t7 format inception model')
...
cmd:option('-batch_size',10,'what is the batch size in number of sentences per batch?')
...
if string.len(opt.start_from) > 0 then
  ...
  protos.cnn = net_utils.build_cnn_inception_2(cnn_raw, {encoding_size = opt.input_encoding_size, backend = cnn_backend})
  cnn_raw = nil
end
