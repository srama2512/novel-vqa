...
print(model_param['embedding_w_q']:size())
print(embedding_w_q:size())
print(model_param['encoder_w_q']:size())
print(encoder_w_q:size())
embedding_w_q:copy(model_param['embedding_w_q']);
encoder_w_q:copy(model_param['encoder_w_q']);
print(model_param['multimodal_w']:size())
print(multimodal_w:size())
