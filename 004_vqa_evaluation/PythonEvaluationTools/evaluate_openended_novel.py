...
vqaEval.evaluate(quesIds['0']) 
answers.append(vqaEval.accuracy['overall']) # novel type score

print('Ov: %.2f Oth: %.2f Num: %.2f Y/N: %.2f Nov: %.2f'%(answers[0], answers[1], answers[2], answers[3], answers[4]))
