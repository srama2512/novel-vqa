...
parser.add_argument('--original_json', default='data_prepro_oracle_best.json', help='path to original json file containing image lists')
parser.add_argument('--save_path', default='image_map.json', help='save path for image map')
